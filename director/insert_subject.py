# ==============================================
# Insert Subject - Complete Python Conversion
# Converted from insert_subject.php
# ==============================================
...
director_insert_subject = Blueprint('director_insert_subject', __name__, url_prefix='/director')
...
@director_insert_subject.route('/insert_subject', methods=['GET', 'POST'])
@login_required
def insert_subject_page():
    ...
    if request.method == 'POST':
        ...
        if not subject_name or not grade_id:
            ...
            try:
                cursor.execute("""
                    INSERT INTO subject (subject_name, subject_code, grade_id, description) 
                    VALUES (%s, %s, %s, %s)
                """, (subject_name, subject_code, grade_id, description))
                conn.commit()
    ...
    <head>
        ...
        <title>Insert Subject - Director Dashboard</title>
    ...
    <body>
        <div class="container py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-plus-circle"></i> Insert New Subject</h2>
            ...
            <div class="form-container">
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Optional: Enter a unique code for this subject</small>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary w-100">
                        <i class="fas fa-save"></i> Insert Subject
                    </button>
                </form>
            </div>
        </div>
